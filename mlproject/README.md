...
Most of the source codes of this project, `MLProject` are stored in the `mlproject` directory.
...
`make create-container` creates and launch the mlproject container.
